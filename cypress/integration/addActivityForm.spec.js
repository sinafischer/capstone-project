describe('AddActivityForm', () => {
  ...
  it('tests if the add button is disabled when activity name exceeds the maximum character number', () => {
  ...
  it('tests if the add button is disabled when activity details exceeds the maximum character number', () => {
